...
void computeRHSv(GRID *g,SOLN *s,double *l2rho,double *linfrho, int myid);
void computeRHSk(GRID *g,SOLN *s,double *l2rho,double *linfrho, int myid);
void computeRHSkv(GRID *g,SOLN *s,double *l2rho, int myid);
...
void ADI(GRID *g,SOLN *s,double cflnum,double dt, int myid);
void DADI(GRID *g,SOLN *s,double cflnum,double dt, int myid);
...
void gaussSeidel(GRID *g,SOLN *s,double cflnum,double dt,int myid);
void lineGaussSeidel(GRID *g,SOLN *s,double cflnum,double dt, int myid);
