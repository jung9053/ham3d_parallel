...
OBJECTS = ham3d.o readGrid.o preprocess.o find_faces.o\
	  ...
	  communicationLinear.o computeRHS.o computeRHSv.o\
     computeRHSk.o computeRHSkv.o computeLinearRHS.o flux_roe3d.o wallFlux.o\
     flux_roe2d.o periodic_bc.o apply_periodic.o apply_periodic_LHS.o\
	  muscld.o muscld_deriv.o roeflx.o computeForce.o outputSolution.o \
